...
describe IceCubed::Schedule do
  ...
  it "yields itself for configuration" do
    ...
    schedule = IceCubed::Schedule.new do |s|
      s.start_time = t1
    end
  ...
  it "initializes with a start_time" do
    ...
    schedule = IceCubed::Schedule.new(t1)
  ...
  it "converts initialized DateTime to Time", expect_warnings: true do
    ...
    schedule = IceCubed::Schedule.new(dt)
    expect(schedule.start_time).to be_a Time
  ...
  describe :next_occurrence do
    ...
    it "should not skip ahead a day when called with a date" do
      schedule = IceCubed::Schedule.new(Time.utc(2014, 1, 1, 12, 34, 56)) do |s|
        s.add_recurrence_rule IceCubed::Rule.hourly
      end
  ...
  describe :duration do
    it "should be based on end_time" do
      start = Time.now
      schedule = IceCubed::Schedule.new(start)
    ...
    it "should give precedence to :end_time option" do
      ...
      schedule = IceCubed::Schedule.new(start, conflicting_options)
  ...
  describe :occurring_at? do
    it "should not capture multiple days when called with a date" do
      schedule = IceCubed::Schedule.new do |s|
        ...
        s.duration = 20
        s.add_recurrence_rule IceCubed::Rule.daily(2)
      end
  ...
  describe :recurrence_times do
    it "should start empty" do
      expect(IceCubed::Schedule.new.recurrence_times).to be_empty
    end

    it "should include added times" do
      schedule = IceCubed::Schedule.new(t0 = Time.now)
  ...
  describe :conflicts_with? do
    ...
    it "should not raise error if both are non-terminating closing time present" do
      schedule1 = IceCubed::Schedule.new Time.now
      schedule1.rrule IceCubed::Rule.weekly
      schedule2 = IceCubed::Schedule.new Time.now
      schedule2.rrule IceCubed::Rule.weekly
      expect do
        schedule1.conflicts_with?(schedule2, Time.now + IceCubed::ONE_DAY)
    ...
    it "should not raise an error if one is non-terminating" do
      ...
      schedule1.rrule IceCubed::Rule.weekly
      schedule2 = IceCubed::Schedule.new Time.now
      schedule2.rrule IceCubed::Rule.weekly.until(Time.now)
      expect do
    ...
    it "should not raise an error if the other is non-terminating" do
      schedule1 = IceCubed::Schedule.new Time.now
      schedule1.rrule IceCubed::Rule.weekly.until(Time.now)
      schedule2 = IceCubed::Schedule.new Time.now
      schedule2.rrule IceCubed::Rule.weekly
      expect do
        schedule1.conflicts_with?(schedule2)
    ...
    it "should return true if conflict is present" do
      start_time = Time.now
      schedule1 = IceCubed::Schedule.new(start_time)
      schedule1.rrule IceCubed::Rule.daily
      schedule2 = IceCubed::Schedule.new(start_time)
      schedule2.rrule IceCubed::Rule.daily
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_DAY)
    ...
    it "should return false if conflict is not present" do
      start_time = Time.now
      schedule1 = IceCubed::Schedule.new(start_time)
      schedule1.rrule IceCubed::Rule.weekly.day(:tuesday)
      schedule2 = IceCubed::Schedule.new(start_time)
      schedule2.rrule IceCubed::Rule.weekly.day(:monday)
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_DAY)
    ...
    it "should return true if conflict is present based on duration" do
      start_time = Time.now
      schedule1 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_DAY + 1)
      schedule1.rrule IceCubed::Rule.weekly.day(:monday)
      schedule2 = IceCubed::Schedule.new(start_time)
      schedule2.rrule IceCubed::Rule.weekly.day(:tuesday)
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_WEEK)
      expect(conflict).to be_truthy
    end
    ...
    it "should return true if conflict is present based on duration - other way" do
      ...
      schedule1 = IceCubed::Schedule.new(start_time)
      schedule1.rrule IceCubed::Rule.weekly.day(:tuesday)
      schedule2 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_DAY + 1)
      schedule2.rrule IceCubed::Rule.weekly.day(:monday)
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_WEEK)
      expect(conflict).to be_truthy
    end
    ...
    it "should return false if conflict is past closing_time" do
      ...
      schedule1 = IceCubed::Schedule.new(start_time)
      schedule1.rrule IceCubed::Rule.weekly.day(:friday)
      schedule2 = IceCubed::Schedule.new(start_time)
      schedule2.rrule IceCubed::Rule.weekly.day(:friday)
      expect(schedule2.conflicts_with?(schedule1, start_time + IceCubed::ONE_WEEK))
        .to be_truthy
      expect(schedule2.conflicts_with?(schedule1, start_time + IceCubed::ONE_DAY))
        .to be_falsey
    end

    it "should return false if conflict is not present based on duration" do
      start_time = Time.now
      schedule1 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_HOUR)
      schedule1.rrule IceCubed::Rule.weekly.day(:monday)
      schedule2 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_HOUR)
      schedule2.rrule IceCubed::Rule.weekly.day(:tuesday)
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_WEEK)
      expect(conflict).to be_falsey
    end
    ...
    it "should return false if conflict is not present on same day based on duration" do
      ...
      schedule1 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_HOUR)
      schedule1.rrule IceCubed::Rule.daily
      schedule2 = IceCubed::Schedule.new(start_time + 3600, duration: IceCubed::ONE_HOUR)
      schedule2.rrule IceCubed::Rule.daily
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_WEEK)
      expect(conflict).to be_falsey
    end
    ...
    it "should return true if conflict is present on same day based on duration" do
      ...
      schedule1 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_HOUR)
      schedule1.rrule IceCubed::Rule.daily
      schedule2 = IceCubed::Schedule.new(start_time + 600, duration: IceCubed::ONE_HOUR)
      schedule2.rrule IceCubed::Rule.daily
      conflict = schedule1.conflicts_with?(schedule2, start_time + IceCubed::ONE_WEEK)
      expect(conflict).to be_truthy
    end
    ...
    it "should return false if conflict is not present and no recurrence" do
      ...
      schedule1 = IceCubed::Schedule.new(start_time, duration: IceCubed::ONE_HOUR)
      schedule1.add_recurrence_time(start_time)
      schedule2 = IceCubed::Schedule.new(start_time + IceCubed::ONE_HOUR, duration: IceCubed::ONE_HOUR)
      schedule2.add_recurrence_time(start_time + IceCubed::ONE_HOUR)
      conflict = schedule1.conflicts_with?(schedule2)
      expect(conflict).to be_falsey
      conflict = schedule2.conflicts_with?(schedule1)
      expect(conflict).to be_falsey
  ...
  describe :all_occurrences_enumerator do
    it "should be equivalent to all_occurrences in terms of arrays" do
      schedule = IceCubed::Schedule.new(Time.now, duration: IceCubed::ONE_HOUR)
      schedule.add_recurrence_rule IceCubed::Rule.daily.until(Time.now + (3 * IceCubed::ONE_DAY))
  ...
  describe :all_occurrences do
    it "has end times for each occurrence" do
      schedule = IceCubed::Schedule.new(Time.now, duration: IceCubed::ONE_HOUR)
      schedule.add_recurrence_rule IceCubed::Rule.daily.until(Time.now + (3 * IceCubed::ONE_DAY))
      schedule.all_occurrences.all? { |o| expect(o.end_time).to eq(o + IceCubed::ONE_HOUR) }
    end
    ...
    it "should have one occurrence with one recurrence time at start_time" do
      schedule = IceCubed::Schedule.new(t0 = Time.local(2012, 12, 12, 12, 12, 12))
      schedule.add_recurrence_time t0
      expect(schedule.all_occurrences).to eq([t0])
    end
  ...
  describe :next_occurrence do
    it "should be able to calculate the next occurrence past an exception time" do
      ...
      expect(occurrence).to eq(start_time + (IceCubed::ONE_DAY * 2))
    end
  ...
  describe :spans do
    it "should find occurrence in past with duration beyond the start time" do
      ...
      schedule = IceCubed::Schedule.new(t0, duration: 2 * IceCubed::ONE_HOUR)
      schedule.add_recurrence_rule IceCubed::Rule.daily
      next_occ = schedule.next_occurrence(t0 + IceCubed::ONE_HOUR, spans: true)
    ...
    it "should include occurrence in past with duration beyond the start time" do
      t0 = Time.utc(2015, 10, 1, 15, 31)
      schedule = IceCubed::Schedule.new(t0, duration: 2 * IceCubed::ONE_HOUR)
      schedule.add_recurrence_rule IceCubed::Rule.daily.count(2)
      occs = schedule.next_occurrences(10, t0 + IceCubed::ONE_HOUR, spans: true)
      expect(occs).to eq([t0, t0 + IceCubed::ONE_DAY])
    end

    it "should allow duration span on remaining_occurrences" do
      t0 = Time.utc(2015, 10, 1, 0o0, 0o0)
      schedule = IceCubed::Schedule.new(t0, duration: IceCubed::ONE_DAY)
      schedule.add_recurrence_rule IceCubed::Rule.daily.count(3)
      occs = schedule.remaining_occurrences(t0 + IceCubed::ONE_DAY + IceCubed::ONE_HOUR, spans: true)
      expect(occs).to eq([t0 + IceCubed::ONE_DAY, t0 + (2 * IceCubed::ONE_DAY)])
    end

    it "should include occurrences with duration spanning the requested start time" do
      t0 = Time.utc(2015, 10, 1, 15, 31)
      schedule = IceCubed::Schedule.new(t0, duration: 30 * IceCubed::ONE_DAY)
      long_event = schedule.remaining_occurrences_enumerator(t0 + IceCubed::ONE_DAY, spans: true).take(1)
    ...
    it "should find occurrences between including previous one with duration spanning start" do
      ...
      schedule = IceCubed::Schedule.new(t0, duration: IceCubed::ONE_HOUR)
      schedule.add_recurrence_rule IceCubed::Rule.hourly.count(10)
      occs = schedule.occurrences_between(t0 + IceCubed::ONE_HOUR + 1, t0 + (3 * IceCubed::ONE_HOUR) + 1, spans: true)
    ...
    it "should include long occurrences starting before and ending after" do
      t0 = Time.utc(2015, 10, 1, 0o0, 0o0)
      schedule = IceCubed::Schedule.new(t0, duration: IceCubed::ONE_DAY)
      occs = schedule.occurrences_between(t0 + IceCubed::ONE_HOUR, t0 + IceCubed::ONE_DAY - IceCubed::ONE_HOUR,
                                          spans: true)
    ...
    it "should not find occurrence with duration ending on start time" do
      ...
      schedule = IceCubed::Schedule.new(t0, duration: IceCubed::ONE_HOUR)
      expect(schedule.occurs_between?(t0 + IceCubed::ONE_HOUR, t0 + (2 * IceCubed::ONE_HOUR),
                                      spans: true)).to be_falsey
    end
    ...
    it "should quickly fetch a future time from a recurring schedule" do
      ...
      schedule = IceCubed::Schedule.new(t0, duration: IceCubed::ONE_HOUR - 1)
    ...
    it "should not include occurrence ending on start time" do
      t0 = Time.utc(2015, 10, 1, 10, 0o0)
      schedule = IceCubed::Schedule.new(t0, duration: IceCubed::ONE_HOUR / 2)
      schedule.add_recurrence_rule IceCubed::Rule.minutely(30).count(6)
      third_occ = schedule.next_occurrence(t0 + IceCubed::ONE_HOUR, spans: true)
      expect(third_occ).to eq(t0 + IceCubed::ONE_HOUR)
    end
  end
  ...
  describe :previous_occurrence do
    it "returns the previous occurrence for a time in the schedule" do
      ...
      schedule.add_recurrence_rule IceCubed::Rule.daily
      previous = schedule.previous_occurrence(t0 + (2 * IceCubed::ONE_DAY))
      expect(previous).to eq(t0 + IceCubed::ONE_DAY)
    end
  ...
  describe :previous_occurrences do
    it "returns an array of previous occurrences from a given time" do
      ...
      schedule = IceCubed::Schedule.new(t0)
      schedule.add_recurrence_rule IceCubed::Rule.daily
      previous = schedule.previous_occurrences(2, t0 + (3 * IceCubed::ONE_DAY))
      expect(previous).to eq([t0 + IceCubed::ONE_DAY, t0 + (2 * IceCubed::ONE_DAY)])
    end
    ...
    it "limits the returned occurrences to a given count" do
      ...
      schedule = IceCubed::Schedule.new(t0)
      schedule.add_recurrence_rule IceCubed::Rule.daily
      previous = schedule.previous_occurrences(999, t0 + (2 * IceCubed::ONE_DAY))
      expect(previous).to eq([t0, t0 + IceCubed::ONE_DAY])
    end
  ...
  describe :last do
    it "returns the last occurrence for a terminating schedule" do
      ...
      schedule = IceCubed::Schedule.new(t0)
      schedule.add_recurrence_rule IceCubed::Rule.daily.until(t1 + 1)
    ...
    it "returns an array of occurrences given a number" do
      ...
      schedule = IceCubed::Schedule.new(t0)
      schedule.add_recurrence_rule IceCubed::Rule.daily.until(t1 + 1)
      expect(schedule.last(2)).to eq([t1 - IceCubed::ONE_DAY, t1])
    end
  ...
  describe :start_time= do
    it "should modify start date in rrule_occurrence_heads when changed" do
      schedule = IceCubed::Schedule.new(Time.now - 1000)
      schedule.rrule IceCubed::Rule.daily
  ...
  describe :remove_recurrence_rule do
    it "should be able to one rule based on the comparator" do
      schedule = IceCubed::Schedule.new Time.now
      schedule.rrule IceCubed::Rule.daily
      schedule.rrule IceCubed::Rule.daily(2)
  ...
  describe :remove_recurrence_time do
    it "should be able to remove a recurrence date from a schedule" do
      time = Time.now
      schedule = IceCubed::Schedule.new(time)
  ...
  describe :occurs_on? do
    subject(:schedule) { IceCubed::Schedule.new(start_time) }
    ...
    shared_examples "occurring on a given day" do
      WORLD_TIME_ZONES.each do |zone|
        context "in #{zone}", system_time_zone: zone do
          ...
          specify "should determine if it occurs on the day of a given ActiveSupport::Time",
                  requires_active_support: true do
    ...
    context "with a recurrence rule limited by count" do
      before { schedule.add_recurrence_rule IceCubed::Rule.daily.count(1) }
      include_examples :occurs_on?
    end

    context "with a recurrence rule limited by until" do
      before { schedule.add_recurrence_rule IceCubed::Rule.daily.until(start_time) }
      include_examples :occurs_on?
    end
    ...
    context "across DST" do
      ...
      before { schedule.add_recurrence_rule(IceCubed::Rule.monthly) }
    ...
    it "should be true for multiple rtimes" do
      schedule = IceCubed::Schedule.new(Time.local(2010, 7, 10, 16))
  ...
  def compare_time_zone_info(start_time)
    schedule = IceCubed::Schedule.new(start_time)
    schedule.rrule IceCubed::Rule.yearly(1)
  ...
  def trap_infinite_loop_beyond(iterations)
    expect_any_instance_of(IceCubed::ValidatedRule).to receive(:finds_acceptable_time?)
