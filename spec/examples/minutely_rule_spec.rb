...
describe IceCubed::MinutelyRule do
  ...
  it "raises errors for misaligned interval and minute_of_hour values" do
    ...
    end.to raise_error(ArgumentError, "intervals in minute_of_hour(3, 6) must be multiples of interval(10)")
  end
  ...
  it "raises errors for misaligned minute_of_hour values when changing interval" do
    ...
    end.to raise_error(ArgumentError, "interval(5) must be a multiple of intervals in minute_of_hour(3, 6)")
  end
end
