...
module IceCubed
  describe Schedule do
    ...
    it "local - should make dates on interval over dst - github issue 4" do
      ...
      expect(schedule.first(3)).to eq([Time.local(2010, 3, 12, 19, 0, 0), Time.local(2010, 3, 15, 19, 0, 0),
                                       Time.local(2010, 3, 18, 19, 0, 0)])
    end
    ...
    it "local - should make dates on yearly interval over dst - github issue 4" do
      ...
      schedule = Schedule.new(start_time)
      schedule.add_recurrence_rule Rule.yearly(2)
      expect(schedule.first(3)).to eq([Time.local(2010, 3, 12, 19, 0, 0), Time.local(2012, 3, 12, 19, 0, 0),
                                       Time.local(2014, 3, 12, 19, 0, 0)])
    end
    ...
    it "local - should make dates on monthly (day of week) inverval over dst - github issue 5" do
      ...
      expect(schedule.first(3)).to eq([Time.local(2010, 3, 7, 12, 0, 0), Time.local(2010, 4, 4, 12, 0, 0),
                                       Time.local(2010, 5, 2, 12, 0, 0)])
    end
    ...
    it "local - should make dates on monthly (day of month) inverval over dst - github issue 5" do
      ...
      expect(schedule.first(3)).to eq([Time.local(2010, 3, 1, 12, 0, 0), Time.local(2010, 4, 1, 12, 0, 0),
                                       Time.local(2010, 5, 1, 12, 0, 0)])
    end
    ...
    it "local - should make dates on weekly (day) inverval over dst - github issue 5" do
      ...
      expect(schedule.first(3)).to eq([Time.local(2010, 3, 7, 12, 0, 0), Time.local(2010, 3, 14, 12, 0, 0),
                                       Time.local(2010, 3, 21, 12, 0, 0)])
    end
    ...
    it "local - should make dates on yearly (day of year) inverval over dst - github issue 5" do
      ...
      expect(schedule.first(3)).to eq([Time.local(2011, 1, 1, 12, 0, 0), Time.local(2012, 1, 1, 12, 0, 0),
    ...
    it "local - should make dates on monthly (month_of_year) inverval over dst - github issue 5" do
      ...
      expect(schedule.first(3)).to eq([Time.local(2010, 4, 10, 12, 0, 0), Time.local(2011, 4, 10, 12, 0, 0),
