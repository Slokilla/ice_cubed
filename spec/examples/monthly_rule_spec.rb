...
module IceCubed
  ...
  describe MonthlyRule do
    ...
    %i[sunday monday tuesday wednesday thursday friday saturday].each_with_index do |weekday, wday|
    ...
    describe "month_of_year validation" do
      ...
      it "raises errors for misaligned interval and month_of_year values" do
        ...
        end.to raise_error(ArgumentError, "month_of_year can only be used with interval(1) or multiples of interval(12)")
      end
