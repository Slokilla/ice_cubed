  ...
  RRULE:FREQ=WEEKLY;INTERVAL=2;WKST=SU;BYDAY=FR
    ...
    describe "instantiation" do
      it "loads an ICAL string" do
        expect(IceCubed::Schedule.from_ical(ical_string)).to be_a(IceCubed::Schedule)
      end
    end
    ...
    describe "daily frequency" do
      ...
      it "handles counts" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.daily.count(4))
      ...
      it "handles intervals" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.daily(4))
      ...
      it "handles intervals and counts" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.daily(4).count(10))
      ...
      it "handles until dates" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.daily.until(start_time + (IceCubed::ONE_DAY * 15)))
    ...
    describe "weekly frequency" do
      ...
      it "handles weekdays" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.weekly.day(:monday, :thursday))
      ...
      it "handles intervals and counts" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.weekly(2).count(4))
      ...
      it "handles intervals and counts on given weekdays" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.weekly(2).day(:monday, :wednesday).count(4))
    ...
    describe "monthly frequency" do
      ...
      it "handles intervals and counts" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.monthly(2).count(5))
      ...
      it "handles intervals and counts on specific days" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.monthly(2).day_of_month(1, 15).count(5))
    ...
    describe "yearly frequency" do
      ...
      it "handles intervals" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.yearly(2))
      ...
      it "handles a specific day" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.yearly.day_of_year(15))
      ...
      it "handles specific days" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.yearly.day_of_year(1, 15, -1))
      ...
      it "handles counts" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.yearly.count(5))
      ...
      it "handles specific months" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.yearly.month_of_year(:january, :december))
      ...
      it "handles specific months and counts" do
        ...
        schedule = IceCubed::Schedule.new(start_time)
        schedule.add_recurrence_rule(IceCubed::Rule.yearly.month_of_year(:january, :december).count(15))
    ...
    describe "invalid ical data" do
      shared_examples_for("an invalid ical string") do
        it do
          ...
          end.to raise_error(ArgumentError) # TODO: replace with real ad
        end
      end
